...
import { loadAvatar } from '../../../store/avatarStorage';
...
useEffect(() => {
  const timer = setTimeout(() => {
    webRef.current?.postMessage('Hello from React Native');
  }, 500);
  ...
  return (
    <View>
      ...
      <Button title="👕 Try On" onPress={tryOn} />
    </View>
  );
}
